...
See [Code Externalization](code-externalization) for details.
...
The deploy command requires authentication. See [Authentication](authentication) for details.

## See Also

- [Export](export) - Export workflows from n8n
- [Manifest File](manifest) - Understand the manifest format
- [Code Externalization](code-externalization) - Learn about include directives
