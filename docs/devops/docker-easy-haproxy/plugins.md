...
- [Cleanup](Plugins/cleanup) - Cleanup temporary files
- [Deny Pages](Plugins/deny-pages) - Block specific paths
- [IP Whitelist](Plugins/ip-whitelist) - Restrict access to IPs/CIDR ranges
- [JWT Validator](Plugins/jwt-validator) - Validate JWT tokens
- [FastCGI](Plugins/fastcgi) - Configure PHP-FPM and FastCGI applications
...
- [Container Labels](container-labels) - Label configuration reference
- [Environment Variables](environment-variable) - Environment variable reference
- [Static Configuration](static) - YAML configuration reference
- [Kubernetes Guide](kubernetes) - Using plugins with Kubernetes
