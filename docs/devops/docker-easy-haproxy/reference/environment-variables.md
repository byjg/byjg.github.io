...
| EASYHAPROXY_CERTBOT_*     | (Optional) Enable Let's Encrypt or any other ACME certificate. See more: [acme](../guides/acme)                                                                                             | *empty*            |
...
(default `http://<host>:11936/`). See the [Monitoring Dashboard guide](../guides/dashboard) for details.
:::
