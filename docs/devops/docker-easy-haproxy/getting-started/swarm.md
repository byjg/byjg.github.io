...
- This method does not work with containers that use the `--network=host` option. See [limitations](../concepts/limitations) for details.
:::
...
**Do not** add more than one replica for EasyHAProxy. To understand why, see the [limitations](../concepts/limitations) page.
:::
...
- [Container label reference](../reference/container-labels) — all available labels
- [Environment variable reference](../reference/environment-variables) — configure EasyHAProxy behavior
- [Docker guide](docker) — more detailed Docker examples
