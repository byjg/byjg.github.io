...
- **[Docker](docker)** — standalone Docker host, container labels
- **[Docker Swarm](swarm)** — overlay network, service labels
- **[Kubernetes](kubernetes)** — Ingress controller, DaemonSet/NodePort
- **[Static YAML](static)** — any environment, config file

### Native host (pip/uv package)

- **[Native install](native)** — HAProxy on the host, `easy-haproxy` CLI
