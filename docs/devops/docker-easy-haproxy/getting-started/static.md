...
The only way to provide SSL certificates in static configuration mode is to map the certificate files as a Docker volume. See the [SSL documentation](../guides/ssl) to learn how to configure this.
:::
...
- [Container label reference](../reference/container-labels) — label semantics also apply to static YAML keys
