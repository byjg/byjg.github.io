...
- [Cloudflare](../reference/plugins/cloudflare) - Restore visitor IP from Cloudflare CDN
- [Cleanup](../reference/plugins/cleanup) - Cleanup temporary files
- [Deny Pages](../reference/plugins/deny-pages) - Block specific paths
- [IP Whitelist](../reference/plugins/ip-whitelist) - Restrict access to IPs/CIDR ranges
- [JWT Validator](../reference/plugins/jwt-validator) - Validate JWT tokens
- [FastCGI](../reference/plugins/fastcgi) - Configure PHP-FPM and FastCGI applications
...
See the [Kubernetes guide](../getting-started/kubernetes) for more examples.
...
Want to create your own plugins? See the [Plugin Developer Guide](plugin-development) for detailed instructions on building custom plugins that extend EasyHAProxy functionality.

## Further Reading

- [Plugin Developer Guide](plugin-development) - Create custom plugins
- [Container Labels](../reference/container-labels) - Label configuration reference
- [Environment Variables](../reference/environment-variables) - Environment variable reference
- [Static Configuration](../getting-started/static) - YAML configuration reference
- [Kubernetes Guide](../getting-started/kubernetes) - Using plugins with Kubernetes
