...
- [ObjectCopy](objectcopy) - Uses property handlers for copying
- [BaseModel](basemodel) - Supports property handlers in constructor
- [DirectTransform](directtransform) - Base implementation of PropertyHandlerInterface
