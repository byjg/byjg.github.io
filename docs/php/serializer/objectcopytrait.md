...
Property handlers can be used with these methods for property transformation. For detailed documentation, see the **[Property Handlers Guide](propertyhandlers)**.
...
- [ObjectCopyInterface](objectcopyinterface) - Interface defining the copy methods
- [ObjectCopy](objectcopy) - Utility class for copying properties between objects
- [BaseModel](basemodel) - Abstract base class using this trait 