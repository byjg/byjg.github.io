...
For detailed documentation on property handlers including all built-in handlers, custom handler creation, and transformation patterns, see the **[Property Handlers Guide](propertyhandlers)**.

## Related Components

- [ObjectCopyTrait](objectcopytrait) - Trait implementing this interface
- [BaseModel](basemodel) - Abstract base class implementing this interface
- [ObjectCopy](objectcopy) - Utility class for property copying
