...
See the **[Integration Examples Guide](integration-examples)** for detailed, working examples.
...
- [Serialize](serialize) - Main serialization class
- [Formatters](formatters) - Output format customization
- [Property Handlers](propertyhandlers) - Property transformation
