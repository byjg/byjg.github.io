...
See the **[Property Handlers Guide](propertyhandlers)**.

## Related Components

- [Property Handlers](propertyhandlers) - Complete guide to property transformation
- [ObjectCopyInterface](objectcopyinterface) - Interface for defining copyable objects
- [ObjectCopyTrait](objectcopytrait) - Trait implementing the interface methods
- [BaseModel](basemodel) - Abstract base class with copying functionality
- [DirectTransform](directtransform) - Base property handler class