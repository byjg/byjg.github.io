...
- [Serialize](serialize) - Main serialization class that uses formatters
- [ObjectCopy](objectcopy) - Copy data between objects before formatting
- [BaseModel](basemodel) - Model base class with `toArray()` for formatting
