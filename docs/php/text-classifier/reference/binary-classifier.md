...
Returns `null` on success or an error code string on failure. See [Error Codes](error-codes).
...
- [ConfigBinaryClassifier reference](config-binary-classifier)
- [ConfigLlm reference](config-llm)
- [How B8 works](../concepts/how-binary-classifier-works)
- [Storage backends](../concepts/storage-backends)
- [Error codes](error-codes)
- [LLM-Assisted Classification](../guides/llm-assisted-classification)
