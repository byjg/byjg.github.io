...
- [How B8 works](../../concepts/how-binary-classifier-works) — the Robinson-Fisher algorithm explained
- [ConfigBinaryClassifier reference](../../reference/config-binary-classifier) — all tuning parameters
