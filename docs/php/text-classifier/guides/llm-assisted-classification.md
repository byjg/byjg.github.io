...
- [LLM active learning concept](../concepts/llm-active-learning)
- [ConfigLlm reference](../reference/config-llm)
- [ClassificationResult in the spam-filter guide](spam-filter/classifying)
- [ClassificationResult in the multi-class guide](multi-class/classifying)
