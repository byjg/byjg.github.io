...
- [Training guide](../guides/multi-class/training) — adding and removing samples, category lifecycle
- [Classifying guide](../guides/multi-class/classifying) — interpreting scores, confidence thresholds
- [LLM-assisted classification](../guides/llm-assisted-classification) — automatic fallback with active learning
- [Persistent SQL storage](../guides/multi-class/storage-rdbms)
- [Example: language detection](../guides/multi-class/example-language-detection)
