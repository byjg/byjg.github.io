...
> **Note:** For complete setup instructions including HttpRequestHandler configuration, see [Setup](setup).
...
- Simple endpoints → Use [Closures](routes-using-closures)
- Modern PHP projects → Use [PHP Attributes](routes-using-php-attributes)

## Additional Configuration

For information on:

- Output processors: See [Output Processors](outprocessor)
- Route metadata: See [Route Metadata](route-metadata)
- Route patterns: See [Defining Route Names](defining-route-names)
- Complete setup: See [Setup](setup)
