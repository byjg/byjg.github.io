...
1. **[Getting Started](getting-started)** - Installation, dependencies, and quick start guide
2. **[Usage](usage)** - Constructor, methods (start, stop), and basic usage
3. **[Configuration](configuration)** - Event callbacks, options, headers, and custom events
4. **[Examples](examples)** - Code examples for common use cases and running examples locally
5. **[Known Limitations and Quirks](quirks)** - Browser compatibility, Ajax fallback limitations, and debugging tips
6. **[API Reference](api-reference)** - Complete API documentation with all methods and properties
7. **[References and Resources](references)** - External resources, specifications, and related projects
