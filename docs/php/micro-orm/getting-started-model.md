...
| Method                                 | Description                               |
|----------------------------------------|-------------------------------------------|
| [Mapper](using-mapper-object) class | Define mappings using the Mapper class    |
| [Attributes](model-attribute)       | Define mappings using PHP 8.3+ attributes |

_See also: [Controlling the data](controlling-the-data) for advanced mapping_
...
You can query the database using the [repository](repository).
