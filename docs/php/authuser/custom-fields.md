...
You can transform fields during read/write operations using mappers. See [Mappers](mappers) for details.
...
- [Mappers](mappers) - Custom field transformations
- [Database Storage](database-storage) - Schema configuration
- [User Properties](user-properties) - Flexible metadata storage
