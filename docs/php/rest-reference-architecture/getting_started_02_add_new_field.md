...
Now we have the table `example_crud` created in the [previous tutorial](getting_started_01_create_table),
...
[Next: Creating a REST method](getting_started_03_create_rest_method)
