...
- Creating your first table following the [getting started tutorial](getting_started_01_create_table)
...
Continue with [creating a new table and CRUD operations](getting_started_01_create_table).
