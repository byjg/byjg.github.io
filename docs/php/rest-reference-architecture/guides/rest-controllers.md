...
- [OpenAPI Integration](../concepts/openapi-integration) - How the spec is generated and used at runtime
- [Attributes Reference](../reference/attributes) - Full attribute reference
- [Authentication](authentication) - JWT and RBAC setup
- [Service Layer](services) - Keeping controllers thin
