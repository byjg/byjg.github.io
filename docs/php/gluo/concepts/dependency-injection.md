...
- [Configuration Guide](../guides/configuration) - Advanced configuration patterns
- [Service Layer](../guides/services) - Registering services in the container
- [Architecture](architecture) - How DI fits the overall architecture
