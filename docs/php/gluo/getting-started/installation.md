...
> **Windows Users**: If you don't have PHP installed in WSL2, please follow the [Windows](windows) guide.
...
- **Install Frontend**: Whether to include the `frontend/` Vite app (login, reset, dashboard, profile). See the [Frontend guide](../guides/frontend).
...
- Creating your first table following the [getting started tutorial](first-table)
...
Continue with [creating a new table and CRUD operations](first-table).
