...
[DatabaseExecutor documentation](database-executor) for the recommended approach.
:::
...
Use [DatabaseExecutor](database-executor) instead for these operations.
:::
...
For a complete migration guide, see [Deprecated Features](deprecated-features).
...
- [DatabaseExecutor](database-executor) - Recommended API for query execution
- [Deprecated Features](deprecated-features) - Migration guide for deprecated methods
