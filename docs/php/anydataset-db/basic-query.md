...
See [DatabaseExecutor documentation](database-executor) for more details.
:::
...
When using entity classes (see [Entity Mapping](entity)), these methods work seamlessly:
...
- [DatabaseExecutor](database-executor) - Recommended API documentation
- [Entity Mapping](entity) - Using entity classes with iterators
- [Deprecated Features](deprecated-features) - Migration guide
- [Transactions](transaction) - Detailed transaction documentation
