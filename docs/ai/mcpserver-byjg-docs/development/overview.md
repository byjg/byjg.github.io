...
public server, you do not need any of this -- see [Connecting a client](../clients).
...
|---|---|---|
| Work on the code, build and query the index | From source with `uv`, stdio | [Running locally](local) |
| Host your own server, with the GitHub webhook | Docker Compose, HTTP | [Self-hosting](self-hosting) |
| Know what a setting does | -- | [Configuration](configuration) |
| Understand how and why it works | -- | [Architecture](architecture) |
