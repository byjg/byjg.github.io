...
To work on the code without Docker, see [Running locally](local) instead.
...
other setting: [Configuration](configuration).
...
Follow [Connecting a client](../clients), using your `BYJG_DOCS_PUBLIC_URL`
