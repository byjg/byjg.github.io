...
That’s when the **[PHP Rest Reference Architecture](https://github.com/byjg/php-gluo)** was born — a project that combines the main components of the ecosystem into a ready-to-use structure:
